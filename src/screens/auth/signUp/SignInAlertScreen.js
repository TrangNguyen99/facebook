...
import {
  loginRequestFromSignInAlertScreen,
  saveTokenDataFromSignInAlertScreen,
...
function SignInAlertScreen({navigation}) {
  ...
  const loadingLoginRequestFromSignInAlertScreen = useSelector(
    (state) => state.auth.loadingLoginRequestFromSignInAlertScreen,
  );
  const usernameCreated = useSelector((state) => state.auth.usernameCreated);
  const tokenMain = useSelector((state) => state.auth.tokenMain);
  const idMain = useSelector((state) => state.auth.idMain);
        ...
        <View style={styles.modal}>
          <View style={styles.modalView}>
            ...
            <Text style={styles.message}>
              Bạn cần nhập thông tin này mỗi khi đăng nhập trên một thiết bị mới
            </Text>
